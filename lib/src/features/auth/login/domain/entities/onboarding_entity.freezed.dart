...
class _$OnboardingEntityImpl implements _OnboardingEntity {
  ...
  @override
  String toString() {
    return 'OnboardingEntity(access: $access, refresh: $refresh, id: $id, firstName: $firstName, lastName: $lastName, mobileNumber: $mobileNumber, email: $email, bloodGroup: $bloodGroup, lastLogin: $lastLogin, mentor: $mentor, customer: $customer, profilePicture: $profilePicture, warnings: $warnings)';
  }
