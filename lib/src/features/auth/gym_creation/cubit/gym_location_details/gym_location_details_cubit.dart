...
part 'gym_location_details_state.dart';
part 'gym_location_details_cubit.freezed.dart';

class GymLocationDetailsCubit extends Cubit<GymLocationDetailsState> {
  GymLocationDetailsCubit() : super(const GymLocationDetailsState());
