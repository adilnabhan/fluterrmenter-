...
mixin _$LeadsListingModel {
  ...
  $LeadsListingModelCopyWith<LeadsListingModel> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $LeadsListingModelCopyWith<$Res> {
  factory $LeadsListingModelCopyWith(LeadsListingModel value, $Res Function(LeadsListingModel) then) = _$LeadsListingModelCopyWithImpl<$Res, LeadsListingModel>;
  @useResult
  $Res call({@JsonKey(name: 'count') int? count, @JsonKey(name: 'next') String? next, @JsonKey(name: 'previous') String? previous, @JsonKey(name: 'results') List<Result>? results});
}

/// @nodoc
class _$LeadsListingModelCopyWithImpl<$Res, $Val extends LeadsListingModel> implements $LeadsListingModelCopyWith<$Res> {
  ...
  @override
  $Res call({Object? count = freezed, Object? next = freezed, Object? previous = freezed, Object? results = freezed}) {
    return _then(
      _value.copyWith(
            count:
                freezed == count
...
/// @nodoc
abstract class _$$LeadsListingModelImplCopyWith<$Res> implements $LeadsListingModelCopyWith<$Res> {
  factory _$$LeadsListingModelImplCopyWith(_$LeadsListingModelImpl value, $Res Function(_$LeadsListingModelImpl) then) = __$$LeadsListingModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: 'count') int? count, @JsonKey(name: 'next') String? next, @JsonKey(name: 'previous') String? previous, @JsonKey(name: 'results') List<Result>? results});
}
...
/// @nodoc
class __$$LeadsListingModelImplCopyWithImpl<$Res> extends _$LeadsListingModelCopyWithImpl<$Res, _$LeadsListingModelImpl> implements _$$LeadsListingModelImplCopyWith<$Res> {
  __$$LeadsListingModelImplCopyWithImpl(_$LeadsListingModelImpl _value, $Res Function(_$LeadsListingModelImpl) _then) : super(_value, _then);
...
class _$LeadsListingModelImpl implements _LeadsListingModel {
  const _$LeadsListingModelImpl({@JsonKey(name: 'count') this.count, @JsonKey(name: 'next') this.next, @JsonKey(name: 'previous') this.previous, @JsonKey(name: 'results') final List<Result>? results})
    : _results = results;

  factory _$LeadsListingModelImpl.fromJson(Map<String, dynamic> json) => _$$LeadsListingModelImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$LeadsListingModelImplCopyWith<_$LeadsListingModelImpl> get copyWith => __$$LeadsListingModelImplCopyWithImpl<_$LeadsListingModelImpl>(this, _$identity);
...
abstract class _LeadsListingModel implements LeadsListingModel {
  ...
  factory _LeadsListingModel.fromJson(Map<String, dynamic> json) = _$LeadsListingModelImpl.fromJson;
  ...
  @override
  @JsonKey(includeFromJson: false, includeToJson: false)
  _$$LeadsListingModelImplCopyWith<_$LeadsListingModelImpl> get copyWith => throw _privateConstructorUsedError;
}
...
class _$ResultImpl implements _Result {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.designation, designation) || other.designation == designation) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, userId, name, mobileNumber, email, designation, created, const DeepCollectionEquality().hash(profilePicture), const DeepCollectionEquality().hash(_categories));
