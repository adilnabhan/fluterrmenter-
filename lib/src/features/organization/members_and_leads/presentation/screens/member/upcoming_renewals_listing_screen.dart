...
class UpcomingRenewalsListingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(create: (context) => MembersAndLeadsCubit(orgId: orgId), child: const _UpcomingRenewalsListingScreen());
  }
}
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          TextField(
            onChanged: (q) {
              EasyDebounce.debounce('upcoming_renewals_search_query', const Duration(milliseconds: 300), () => _fetch(searchQuery: q));
            },
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                OutlinedButton(
                                  ...
                                  onPressed: () {},
                                  child: Text('Sort by', style: AppStyles.text12Px.poppins.copyWith(color: const Color(0xff222222))),
                                ),
                              ],
                            ),
                            Expanded(
