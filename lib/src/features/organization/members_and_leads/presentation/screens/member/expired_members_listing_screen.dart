...
class ExpiredMembersListingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _ExpiredMembersListingScreen(),
    );
  }
}
...
class _ExpiredMembersListingScreen extends StatefulWidget {
  ...
  @override
  State<_ExpiredMembersListingScreen> createState() =>
      __ExpiredMembersListingScreenState();
}

class __ExpiredMembersListingScreenState
    extends State<_ExpiredMembersListingScreen>
