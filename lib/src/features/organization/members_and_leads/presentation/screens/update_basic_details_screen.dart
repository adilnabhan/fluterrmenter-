...
class UpdateBasicDetailsScreen extends StatefulWidget {
  ...
  @override
  State<UpdateBasicDetailsScreen> createState() =>
      _UpdateBasicDetailsScreenState();
}
...
class _UpdateBasicDetailsScreenState extends State<UpdateBasicDetailsScreen> {
  ...
  void initState() {
    ...
    imageUrl =
        memebrDetails?.profilePicture.toString() ??
        leadDetails?.profilePicture.toString();
    _fields = [
      FieldData(
        type: FieldType.word,
        ...
        controller: TextEditingController(
          text: leadDetails?.firstName ?? memebrDetails?.firstName,
        ),
        // focusNode: FocusNode(),
      ...
      FieldData(
        ...
        requiredLabel: false,
        controller: TextEditingController(
          text: leadDetails?.email ?? memebrDetails?.email,
        ),
        focusNode: FocusNode(),
        validator: (value) {
      ...
      FieldData(
        ...
        requiredLabel: true,
        controller: TextEditingController(
          text: (leadDetails?.mobileNumber ?? memebrDetails?.mobileNumber)
              ?.replaceAll('+91', ''),
        ),
        focusNode: FocusNode(),
      ...
      FieldData(
        ...
        requiredLabel: false,
        controller: TextEditingController(
          text: (leadDetails?.gender ?? memebrDetails?.gender)?.toUpperCase(),
        ),
        focusNode: FocusNode(),
        items: [
    ...
    return MultiBlocListener(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            'Update ${widget.details?.fold((l) => 'Trainer', (r) => 'Member')}',
          ),
        ),
        body: Form(
          key: _formKey,
