...
OrganizationDetailsModel _$OrganizationDetailsModelFromJson(Map<String, dynamic> json) {
...
mixin _$OrganizationDetailsModel {
  ...
  $OrganizationDetailsModelCopyWith<OrganizationDetailsModel> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OrganizationDetailsModelCopyWith<$Res> {
  factory $OrganizationDetailsModelCopyWith(OrganizationDetailsModel value, $Res Function(OrganizationDetailsModel) then) = _$OrganizationDetailsModelCopyWithImpl<$Res, OrganizationDetailsModel>;
  @useResult
  $Res call({
...
/// @nodoc
class _$OrganizationDetailsModelCopyWithImpl<$Res, $Val extends OrganizationDetailsModel> implements $OrganizationDetailsModelCopyWith<$Res> {
...
/// @nodoc
abstract class _$$OrganizationDetailsModelImplCopyWith<$Res> implements $OrganizationDetailsModelCopyWith<$Res> {
  factory _$$OrganizationDetailsModelImplCopyWith(_$OrganizationDetailsModelImpl value, $Res Function(_$OrganizationDetailsModelImpl) then) = __$$OrganizationDetailsModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    @JsonKey(name: 'id') int? id,
...
/// @nodoc
class __$$OrganizationDetailsModelImplCopyWithImpl<$Res> extends _$OrganizationDetailsModelCopyWithImpl<$Res, _$OrganizationDetailsModelImpl> implements _$$OrganizationDetailsModelImplCopyWith<$Res> {
  __$$OrganizationDetailsModelImplCopyWithImpl(_$OrganizationDetailsModelImpl _value, $Res Function(_$OrganizationDetailsModelImpl) _then) : super(_value, _then);
...
class _$OrganizationDetailsModelImpl implements _OrganizationDetailsModel {
  ...
  factory _$OrganizationDetailsModelImpl.fromJson(Map<String, dynamic> json) => _$$OrganizationDetailsModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.takeFreeTrial, takeFreeTrial) || other.takeFreeTrial == takeFreeTrial) &&
            (identical(other.isOnFreeTrial, isOnFreeTrial) || other.isOnFreeTrial == isOnFreeTrial) &&
            (identical(other.location, location) || other.location == location) &&
            const DeepCollectionEquality().equals(other._workingDays, _workingDays) &&
            const DeepCollectionEquality().equals(other._socialMedia, _socialMedia) &&
            const DeepCollectionEquality().equals(other._services, _services) &&
            const DeepCollectionEquality().equals(other._amenities, _amenities) &&
            const DeepCollectionEquality().equals(other._categories, _categories) &&
            const DeepCollectionEquality().equals(other._photos, _photos) &&
            const DeepCollectionEquality().equals(other._packages, _packages) &&
            const DeepCollectionEquality().equals(other.subscriptionDetails, subscriptionDetails));
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$OrganizationDetailsModelImplCopyWith<_$OrganizationDetailsModelImpl> get copyWith => __$$OrganizationDetailsModelImplCopyWithImpl<_$OrganizationDetailsModelImpl>(this, _$identity);
...
abstract class _OrganizationDetailsModel implements OrganizationDetailsModel {
  ...
  factory _OrganizationDetailsModel.fromJson(Map<String, dynamic> json) = _$OrganizationDetailsModelImpl.fromJson;
  ...
  @override
  @JsonKey(includeFromJson: false, includeToJson: false)
  _$$OrganizationDetailsModelImplCopyWith<_$OrganizationDetailsModelImpl> get copyWith => throw _privateConstructorUsedError;
}
...
mixin _$AmenityModel {
  ...
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $AmenityModelCopyWith<AmenityModel> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AmenityModelCopyWith<$Res> {
  factory $AmenityModelCopyWith(AmenityModel value, $Res Function(AmenityModel) then) = _$AmenityModelCopyWithImpl<$Res, AmenityModel>;
  @useResult
  $Res call({@JsonKey(name: 'id') int? id, @JsonKey(name: 'name') String? name});
}

/// @nodoc
class _$AmenityModelCopyWithImpl<$Res, $Val extends AmenityModel> implements $AmenityModelCopyWith<$Res> {
...
/// @nodoc
abstract class _$$AmenityModelImplCopyWith<$Res> implements $AmenityModelCopyWith<$Res> {
  factory _$$AmenityModelImplCopyWith(_$AmenityModelImpl value, $Res Function(_$AmenityModelImpl) then) = __$$AmenityModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: 'id') int? id, @JsonKey(name: 'name') String? name});
}
...
/// @nodoc
class __$$AmenityModelImplCopyWithImpl<$Res> extends _$AmenityModelCopyWithImpl<$Res, _$AmenityModelImpl> implements _$$AmenityModelImplCopyWith<$Res> {
  __$$AmenityModelImplCopyWithImpl(_$AmenityModelImpl _value, $Res Function(_$AmenityModelImpl) _then) : super(_value, _then);
...
class _$AmenityModelImpl implements _AmenityModel {
  const _$AmenityModelImpl({@JsonKey(name: 'id') this.id, @JsonKey(name: 'name') this.name});

  factory _$AmenityModelImpl.fromJson(Map<String, dynamic> json) => _$$AmenityModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$AmenityModelImpl && (identical(other.id, id) || other.id == id) && (identical(other.name, name) || other.name == name));
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AmenityModelImplCopyWith<_$AmenityModelImpl> get copyWith => __$$AmenityModelImplCopyWithImpl<_$AmenityModelImpl>(this, _$identity);
...
abstract class _AmenityModel implements AmenityModel {
  const factory _AmenityModel({@JsonKey(name: 'id') final int? id, @JsonKey(name: 'name') final String? name}) = _$AmenityModelImpl;

  factory _AmenityModel.fromJson(Map<String, dynamic> json) = _$AmenityModelImpl.fromJson;
  ...
  @override
  @JsonKey(includeFromJson: false, includeToJson: false)
  _$$AmenityModelImplCopyWith<_$AmenityModelImpl> get copyWith => throw _privateConstructorUsedError;
}
...
abstract class $LocationModelCopyWith<$Res> {
  factory $LocationModelCopyWith(LocationModel value, $Res Function(LocationModel) then) = _$LocationModelCopyWithImpl<$Res, LocationModel>;
  @useResult
  $Res call({
...
abstract class _$$LocationModelImplCopyWith<$Res> implements $LocationModelCopyWith<$Res> {
  factory _$$LocationModelImplCopyWith(_$LocationModelImpl value, $Res Function(_$LocationModelImpl) then) = __$$LocationModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    @JsonKey(name: 'building_name') String? buildingName,
...
/// @nodoc
class __$$LocationModelImplCopyWithImpl<$Res> extends _$LocationModelCopyWithImpl<$Res, _$LocationModelImpl> implements _$$LocationModelImplCopyWith<$Res> {
  __$$LocationModelImplCopyWithImpl(_$LocationModelImpl _value, $Res Function(_$LocationModelImpl) _then) : super(_value, _then);
...
class _$LocationModelImpl implements _LocationModel {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.buildingName, buildingName) || other.buildingName == buildingName) &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, buildingName, street, city, state, pinCode, const DeepCollectionEquality().hash(latitude), const DeepCollectionEquality().hash(longitude));
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$LocationModelImplCopyWith<_$LocationModelImpl> get copyWith => __$$LocationModelImplCopyWithImpl<_$LocationModelImpl>(this, _$identity);
...
mixin _$PhotoModel {
  ...
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $PhotoModelCopyWith<PhotoModel> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PhotoModelCopyWith<$Res> {
  factory $PhotoModelCopyWith(PhotoModel value, $Res Function(PhotoModel) then) = _$PhotoModelCopyWithImpl<$Res, PhotoModel>;
  @useResult
  $Res call({@JsonKey(name: 'id') int? id, @JsonKey(name: 'image') String? image, @JsonKey(name: 'caption') String? caption, @JsonKey(name: 'is_primary') bool? isPrimary});
}

/// @nodoc
class _$PhotoModelCopyWithImpl<$Res, $Val extends PhotoModel> implements $PhotoModelCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? id = freezed, Object? image = freezed, Object? caption = freezed, Object? isPrimary = freezed}) {
    return _then(
      _value.copyWith(
            id:
                freezed == id
...
/// @nodoc
abstract class _$$PhotoModelImplCopyWith<$Res> implements $PhotoModelCopyWith<$Res> {
  factory _$$PhotoModelImplCopyWith(_$PhotoModelImpl value, $Res Function(_$PhotoModelImpl) then) = __$$PhotoModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: 'id') int? id, @JsonKey(name: 'image') String? image, @JsonKey(name: 'caption') String? caption, @JsonKey(name: 'is_primary') bool? isPrimary});
}
...
/// @nodoc
class __$$PhotoModelImplCopyWithImpl<$Res> extends _$PhotoModelCopyWithImpl<$Res, _$PhotoModelImpl> implements _$$PhotoModelImplCopyWith<$Res> {
  __$$PhotoModelImplCopyWithImpl(_$PhotoModelImpl _value, $Res Function(_$PhotoModelImpl) _then) : super(_value, _then);
...
class _$PhotoModelImpl implements _PhotoModel {
  const _$PhotoModelImpl({@JsonKey(name: 'id') this.id, @JsonKey(name: 'image') this.image, @JsonKey(name: 'caption') this.caption, @JsonKey(name: 'is_primary') this.isPrimary});

  factory _$PhotoModelImpl.fromJson(Map<String, dynamic> json) => _$$PhotoModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isPrimary, isPrimary) || other.isPrimary == isPrimary));
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PhotoModelImplCopyWith<_$PhotoModelImpl> get copyWith => __$$PhotoModelImplCopyWithImpl<_$PhotoModelImpl>(this, _$identity);
...
abstract class _PhotoModel implements PhotoModel {
  ...
  factory _PhotoModel.fromJson(Map<String, dynamic> json) = _$PhotoModelImpl.fromJson;
  ...
  @override
  @JsonKey(includeFromJson: false, includeToJson: false)
  _$$PhotoModelImplCopyWith<_$PhotoModelImpl> get copyWith => throw _privateConstructorUsedError;
}
...
mixin _$WorkingDayModel {
  ...
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $WorkingDayModelCopyWith<WorkingDayModel> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $WorkingDayModelCopyWith<$Res> {
  factory $WorkingDayModelCopyWith(WorkingDayModel value, $Res Function(WorkingDayModel) then) = _$WorkingDayModelCopyWithImpl<$Res, WorkingDayModel>;
  @useResult
  $Res call({
...
/// @nodoc
class _$WorkingDayModelCopyWithImpl<$Res, $Val extends WorkingDayModel> implements $WorkingDayModelCopyWith<$Res> {
...
/// @nodoc
abstract class _$$WorkingDayModelImplCopyWith<$Res> implements $WorkingDayModelCopyWith<$Res> {
  factory _$$WorkingDayModelImplCopyWith(_$WorkingDayModelImpl value, $Res Function(_$WorkingDayModelImpl) then) = __$$WorkingDayModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    @JsonKey(name: 'day') String? day,
...
/// @nodoc
class __$$WorkingDayModelImplCopyWithImpl<$Res> extends _$WorkingDayModelCopyWithImpl<$Res, _$WorkingDayModelImpl> implements _$$WorkingDayModelImplCopyWith<$Res> {
  __$$WorkingDayModelImplCopyWithImpl(_$WorkingDayModelImpl _value, $Res Function(_$WorkingDayModelImpl) _then) : super(_value, _then);
...
class _$WorkingDayModelImpl implements _WorkingDayModel {
  ...
  factory _$WorkingDayModelImpl.fromJson(Map<String, dynamic> json) => _$$WorkingDayModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.morningOpeningTime, morningOpeningTime) || other.morningOpeningTime == morningOpeningTime) &&
            (identical(other.morningClosingTime, morningClosingTime) || other.morningClosingTime == morningClosingTime) &&
            (identical(other.eveningOpeningTime, eveningOpeningTime) || other.eveningOpeningTime == eveningOpeningTime) &&
            (identical(other.eveningClosingTime, eveningClosingTime) || other.eveningClosingTime == eveningClosingTime));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, day, isOpen, morningOpeningTime, morningClosingTime, eveningOpeningTime, eveningClosingTime);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$WorkingDayModelImplCopyWith<_$WorkingDayModelImpl> get copyWith => __$$WorkingDayModelImplCopyWithImpl<_$WorkingDayModelImpl>(this, _$identity);
...
abstract class _WorkingDayModel implements WorkingDayModel {
  ...
  factory _WorkingDayModel.fromJson(Map<String, dynamic> json) = _$WorkingDayModelImpl.fromJson;
  ...
  @override
  @JsonKey(includeFromJson: false, includeToJson: false)
  _$$WorkingDayModelImplCopyWith<_$WorkingDayModelImpl> get copyWith => throw _privateConstructorUsedError;
}
