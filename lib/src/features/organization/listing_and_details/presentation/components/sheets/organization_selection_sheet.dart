...
class _OrganizationSelectionSheetState extends State<OrganizationSelectionSheet> with SingleTickerProviderStateMixin {
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [Text('Accounts', style: AppStyles.text18Px.poppins.w600.dark), IconButton(onPressed: context.pop, icon: const Icon(Icons.close, color: AppColors.textGrey))],
        ),
        Flexible(
