...
class _OrganizationListingAndDetailsScreenState extends State<_OrganizationListingAndDetailsScreen> {
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            body: BlocBuilder<OrganizationListingAndDetailsCubit, OrganizationListingAndDetailsState>(
              buildWhen: (p, c) => p.homeData != c.homeData || p.selectedOrganization != c.selectedOrganization || p.details != c.details,
              builder: (context, state) {
                return state.details.fold(_onLoading, (either) {
                  return either.fold(_onError, (orgDetails) {
                    if (!(orgDetails.isOnFreeTrial ?? false) && !(orgDetails.isSubscribed ?? false)) {
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text('Need Help?', style: AppStyles.text16Px.poppins.w600.copyWith(color: AppColors.primary)),
                                          ],
                                        ),
                                        const SizedBox(height: 12),
                                        Text('Get instant support via WhatsApp or call us directly', style: AppStyles.text12Px.poppins.w400.copyWith(color: AppColors.dark.withAlpha(150))),
                                        const SizedBox(height: 16),
                                        Row(
                                          children: [
                                            Expanded(
                                              child: InkWell(
                                                onTap: CustomerSupportServices.whatsappChat,
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      const SizedBox(width: 8),
                                                      Text('WhatsApp', style: AppStyles.text14Px.poppins.w600.copyWith(color: Colors.white)),
                                                    ],
                                                  ),
                                                ),
                                              ),
                                            ...
                                            Expanded(
                                              child: InkWell(
                                                onTap: CustomerSupportServices.phoneCall,
                                                borderRadius: BorderRadius.circular(12),
                                                child: Container(
                                                  padding: const EdgeInsets.symmetric(vertical: 12, horizontal: 16),
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      const SizedBox(width: 8),
                                                      Text('Call Us', style: AppStyles.text14Px.poppins.w600.copyWith(color: Colors.white)),
                                                    ],
                                                  ),
                                                ),
                                              ),
                                ...
                                child: SizedBox(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text('Did you know?', style: AppStyles.text14Px.poppins.w500.dark),
                                      const SizedBox(height: 24),
                                      Text('Strong Businesses', style: AppStyles.text26Px.titanOne.w400.copyWith(color: const Color(0xff878787))),
                                      Text('Made', style: AppStyles.text36Px.titanOne.w400.copyWith(color: const Color(0xff878787))),
                                      Text('Not Born', style: AppStyles.text26Px.titanOne.w400.copyWith(color: const Color(0xff878787))),
                                      const SizedBox(height: 24),
                                      Text('Built by fitness lovers 🧡', style: AppStyles.text14Px.poppins.w400.copyWith(color: const Color(0xff666666))),
  ...
  Widget _onLoading() {
    return Scaffold(
      appBar: AppBar(title: KShimmer(height: 36, width: context.width * .35, radius: 9999999), centerTitle: false, actions: [const KShimmer(height: 48, width: 48, radius: 9999999).pOnly(right: 16)]),
          ...
          children: [
            ListView(
              ...
              children: [
                      ...
                      child: ColoredBox(
                        ...
                        child: const Column(
                          ...
                          children: [
                            ...
                            Spacer(),
                            Row(children: [Flexible(child: KShimmer(height: 16, width: double.maxFinite, radius: 4)), SizedBox(width: 8), KShimmer(height: 36, width: 36, radius: 18)]),
                          ],
                        ).pad(16),
                      ),
                    );
                ...
                const SizedBox(height: 40),
                const AspectRatio(aspectRatio: 16 / 9, child: ClipRRect(borderRadius: BorderRadius.all(Radius.circular(16)), child: KShimmer())),
                const SizedBox(height: 40),
                ...
                Container(
                  ...
                  child: const Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Row(children: [KShimmer(height: 20, width: 20, radius: 10), SizedBox(width: 8), KShimmer(height: 16, width: 80, radius: 4)]),
                      SizedBox(height: 12),
                      KShimmer(height: 12, width: double.maxFinite, radius: 4),
                      SizedBox(height: 16),
                      Row(
                        children: [
                          Expanded(child: KShimmer(height: 44, width: double.maxFinite, radius: 12)),
                          SizedBox(width: 12),
                          Expanded(child: KShimmer(height: 44, width: double.maxFinite, radius: 12)),
                        ],
                      ),
  ...
  Widget _onError(ApiException error) =>
      error.maybeWhen(network: (e) => ErrorUi.network(onTap: _fetch), notFound: (e) => ErrorUi.notFound(onTap: _fetch), orElse: () => ErrorUi.server(onTap: _fetch)).center;
}
